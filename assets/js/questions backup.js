...
function compare(event) {
    ...
    if (element.matches("button")) {
        document.getElementById('guessCorrect')

        // Correct condition 
        if (element.textContent == questions[questionIndex].answer) {

            score++;
            guessCorrect.textContent = "Correct! The answer is:  " + questions[questionIndex].answer;
            // Correct condition 
        } else {
            // Will deduct -10 seconds off secondsLeft for wrong answers
            secondsLeft = secondsLeft - penalty;
            guessCorrect.textContent = "Wrong! The correct answer is:  " + questions[questionIndex].answer;
        }
    ...
    if (questionIndex >= questions.length) {
        ...
        allDone();
        guessCorrect.textContent = "End of quiz!" + " " + "You got  " + score + "/" + questions.length + " Correct!";
    } else {
        render(questionIndex);
    }
